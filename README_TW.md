...
4. **生成角色圖** - 為每個角色生成 AI 人設圖
5. **生成場景圖** - 為每個場景生成參考圖（可選）
6. **編輯章節 / AI拆分分鏡** - 編輯章節內容，AI自動拆分為分鏡；編輯時支援增量更新解析角色和場景
7. **JSON結構** - 生成分鏡資料（角色、場景、鏡頭描述）
8. **生成合併角色圖** - 將多角色合併為參考圖（用於分鏡生成）
9. **生成分鏡圖片** - 根據分鏡描述生成場景圖片
10. **生成分鏡視訊** - 將分鏡圖片轉換為視訊片段
11. **生成分鏡轉場視訊** - 在分鏡間生成過渡視訊（可選）
12. **合併視訊** - 將所有片段合成為完整視訊
...
- 進入【場景庫】頁面，點擊【生成所有場景圖】（可選）

### 4. 編輯章節與 AI 拆分分鏡
- 進入【章節生成】頁面，點擊【AI 拆分分鏡】自動拆分為分鏡
- 進入【章節編輯】頁面編輯章節內容，且編輯時支援增量更新解析角色和場景
