...
class Novel(Base):
    ...
    chapter_split_prompt_template_id = Column(String, nullable=True)  # 关联的章节拆分提示词模板ID
    aspect_ratio = Column(String, default="16:9")  # 画面比例: 16:9, 9:16, 4:3, 3:4, 1:1, 21:9, 2.35:1
