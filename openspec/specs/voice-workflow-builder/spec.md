# voice-workflow-builder Specification

## Purpose
Defines the requirements for voice workflow builders that support CR Prompt Text node replacement for TTS (Text-to-Speech) functionality.
