...
export default {
  ...
  tasks: {
    ...
    workflowNames: {
      ...
      '系统默认-音色设计': 'System Default - Voice Design',
      '系统默认-音频生成': 'System Default - Audio Generation',
    ...
    workflowDescriptions: {
      ...
      '系统预设的音色设计工作流': 'System preset voice design workflow',
      '基于文本提示词设计音色，生成语音': 'Design voice based on text prompts, generate speech',
      '基于参考音频生成语音，支持情感提示词控制': 'Generate speech from reference audio, supports emotion prompt control',
