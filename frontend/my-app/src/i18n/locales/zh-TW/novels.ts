...
export default {
  novels: {
    ...
    characterParsePromptHint: '選擇用於從小說文本解析角色資訊的提示詞',
    sceneParsePromptLabel: '場景解析提示詞',
    sceneParsePromptHint: '選擇用於從小說文本解析場景資訊的提示詞',
    propParsePromptLabel: '道具解析提示詞',
    propParsePromptHint: '選擇用於從小說文本解析道具資訊的提示詞',
    scenePromptLabel: '場景生成提示詞',
    scenePromptHint: '選擇用於生成場景圖片的提示詞模板',
    propPromptLabel: '道具生成提示詞',
    ...
    parsePropsConfirmMessage: '將使用 AI 分析小說內容並自動提取道具資訊，是否繼續？',
