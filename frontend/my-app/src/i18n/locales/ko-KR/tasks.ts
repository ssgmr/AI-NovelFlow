...
export default {
  tasks: {
    ...
    workflowNames: {
      ...
      '系统默认-音色设计': '시스템 기본-음성 디자인',
      '系统默认-音频生成': '시스템 기본-오디오 생성',
    ...
    workflowDescriptions: {
      ...
      '系统预设的音色设计工作流': '시스템 기본 음성 디자인 워크플로우',
      '基于文本提示词设计音色，生成语音': '텍스트 프롬프트로 음성을 디자인하고 생성',
      '基于参考音频生成语音，支持情感提示词控制': '참조 오디오에서 음성 생성, 감정 프롬프트 제어 지원',
