...
export default {
  tasks: {
    ...
    workflowNames: {
      ...
      '系统默认-音色设计': 'システム既定-音色デザイン',
      '系统默认-音频生成': 'システム既定-音声生成',
    ...
    workflowDescriptions: {
      ...
      '系统预设的音色设计工作流': 'システム既定の音色デザインワークフロー',
      '基于文本提示词设计音色，生成语音': 'テキストプロンプトで音色をデザインし、音声を生成',
      '基于参考音频生成语音，支持情感提示词控制': '参照音声から音声を生成、感情プロンプト制御対応',
